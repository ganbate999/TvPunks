...
function App() {
  ...
  */
  ...
  const objTokenCount = useContractReader(readContracts, "TvPunks", "getRemainCollections");
  ...
  const param = [address]
  const userHaveToken = useContractReader(readContracts, "TvPunks", "userHaveTokens", param);
  useEffect(() => {
          ...
          <Router>
            <Switch>
              <Layout>
                ...
                {/* <Route path="/" exact>
                  <Mint 
                  contract={readContracts["TvPunks"]}
                  signer={userSigner}
