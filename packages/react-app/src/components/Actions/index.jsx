...
export const Messages = ({ total, onClick, disableTooltip = false }) => (
  <ActionItem
    title="My Messages"
    icon={MailIcon}
    onClick={onClick}
...
export const More = ({ onClick, disableTooltip = false }) => (
  <ActionItem title="More" icon={MoreIcon} onClick={onClick} disableTooltip={disableTooltip} />
);

export const Notifications = ({ total, onClick, disableTooltip = false }) => (
  <ActionItem
    title="Notifications"
